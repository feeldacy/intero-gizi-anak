    ...
    public function getNutritionSummary(): JsonResponse
    {
        try {
            ...
            foreach ($allChildren as $child) {
                ...
                if ($latestRecord) {
                    if ($latestRecord->nutrition_status === 'Berat Badan Kurang (Underweight)' || $latestRecord->nutrition_status === 'Kelebihan Berat Badan (Overweight)' || $latestRecord->nutrition_status === 'Obesitas I') {
                        $giziBuruk++;
